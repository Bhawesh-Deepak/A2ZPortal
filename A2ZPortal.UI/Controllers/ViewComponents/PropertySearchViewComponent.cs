...
namespace A2ZPortal.UI.Controllers.ViewComponents
{
    public class PropertySearchViewComponent:ViewComponent
    {
        ...
        public PropertySearchViewComponent(IGenericRepository<Location, int> iLocationGenericRepository,
        ...
        {            
            ...
            return await Task.FromResult((IViewComponentResult)View("_PropertySearch" ));
        }
