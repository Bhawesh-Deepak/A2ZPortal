...
function GetDetail() {
    ...
    $.get("/UpComingProperty/GetDetail",
        function (data) {
            $("#divData").html(data);
...
function Create() {
    $.get("/UpComingProperty/Create",
        function (data) {
            debugger;
            $("#headerText").text("UpComing Property Create");
            $("#divCreate").html(data);
...
function Edit(id) {
    $("#divContent").addClass("loading");
    $.get("/UpComingProperty/Create", { id: id },
        function (data) {
